...
namespace FamousHumidors.Controllers
{
    public class SearchController : Controller
    {
        ...
        // GET: Search
        [OutputCache(CacheProfile = Globals.CacheDuration, VaryByParam = "page;resultsPerPage;sortID;categoryID;priceID;humidorSizeID", Location = OutputCacheLocation.Server)]
        public ActionResult Index(int page = 1, int resultsPerPage = 8, int sortID = 1, int categoryID = 1, int priceID = 0, int humidorSizeID = 0)
        {
            ...
            try
            {
                searchModel = new SearchModel(page, resultsPerPage, sortID, categoryID, priceID, humidorSizeID);
